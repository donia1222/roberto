...
(function() {
    ...
    function updateIcons(isDark) {
        ...
        document.querySelectorAll('.dm-label-dark').forEach(function(el) { el.style.display = isDark ? 'none' : 'block'; });
        document.querySelectorAll('.dm-label-light').forEach(function(el) { el.style.display = isDark ? 'block' : 'none'; });
    }
...
var i18nMap = [
    ...
    {s: '#services .service-card:nth-child(1) h4', k: 'service1.title'},
    {s: '#services .service-card:nth-child(1) p', k: 'service1.desc'},
    {s: '#services .service-card:nth-child(1) .service-link', k: 'service1.link', suffix: ' →'},
    {s: '#services .service-card:nth-child(2) h4', k: 'service2.title'},
    {s: '#services .service-card:nth-child(2) p', k: 'service2.desc'},
    {s: '#services .service-card:nth-child(2) .service-link', k: 'service2.link', suffix: ' →'},
    {s: '#services .service-card--cta h3', k: 'services.cta.title'},
    {s: '#services .service-card--cta > p', k: 'services.cta.desc'},
    {s: '#services .service-cta-btn', k: 'services.cta.btn'},
    {s: '#services .service-card:nth-child(4) h4', k: 'service3.title'},
    {s: '#services .service-card:nth-child(4) p', k: 'service3.desc'},
    {s: '#services .service-card:nth-child(4) .service-link', k: 'service3.link', suffix: ' →'},
    {s: '#services .service-card:nth-child(5) h4', k: 'service4.title'},
    {s: '#services .service-card:nth-child(5) p', k: 'service4.desc'},
    {s: '#services .service-card:nth-child(5) .service-link', k: 'service4.link', suffix: ' →'},
    // Apps
    // Pricing
...
'11. **Über den Gründer, Roberto Salvador Lopez**: Seit über 6 Jahren im Geschäft, über 50+ Apps & Websites realisiert. Ansässig in Buchs SG, Kanton St. Gallen, Schweiz. Arbeitet auch mit Kunden in Liechtenstein, Rheintal, Sargans, Sevelen. Sprachen: Deutsch, Spanisch, Englisch.\n\n' +
